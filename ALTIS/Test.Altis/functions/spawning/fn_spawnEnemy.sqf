//BIS_fnc_spawnEnemy
//A3\functions_f\Spawning\fn_spawnEnemy.sqf
...
//Moved code out to facilitate spawning in the same area
	...
	_position = 180 + random 40;
	_direction = _dirToTarget + 90 + random 180;
//
...
while {true} do {
	...
	_pos = [position _player, _position, _direction] call BIS_fnc_relPos;
